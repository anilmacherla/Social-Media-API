package com.anilmacherla.socialmedia.presentation;

import com.anilmacherla.socialmedia.service.PersonNodeDto;
import com.anilmacherla.socialmedia.service.PersonService;
...
public class PersonControllerTest {
    ...
    void assertFindAll() throws Exception{
        when(personService.findAll())
                .thenReturn(List.of(
                        new PersonNodeDto(null,"Zeljko","anilmacherla","yatotoast","xyz@gmail.com")
                ));
